...
--
-- Хост: localhost:3306
-- Время создания: Дек 27 2018 г., 16:26
...
(1, 'admin@admin.com', 'admin', '', '', '', '', 1, 'member, writer, host,admin', '', '2018-12-27 13:17:48', '21415347170000', '$2y$10$m1/hrN7Gp9osrx2ajmcWouas8bQJbSwFpQLqjtCKZoSOVx./UWENC', 0),
...
(1, 1, 0, 0, '127.0.0.1', '2018-12-27 16:26:26', 'podcast, ', '2018-12-27 10:42:54', '2018-12-27 14:34:29', '2018-12-27 13:17:48', NULL, NULL),
...
(1, 'Interview Abed Halawi, Tech Lead at Vinelab', 'An interview with Abed Halawi, Laracon EU speaker and Tech Lead at Vinelab', 'An interview with Abed Halawi, Laracon EU speaker and Tech Lead at Vinelab', 'laravel, php, podcast', 136, 'Serhii Cho', '2017-09-29 18:59:00', '0:45:20', 2, 'admin, ');
...
--
-- Дамп данных таблицы `searchstat`
--

INSERT INTO `searchstat` (`id`, `words`, `times`, `last_date`) VALUES
(1, 'podcast', 1, '2018-12-27 16:20:46');
